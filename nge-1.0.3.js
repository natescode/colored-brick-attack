(function(window) {
	...
	var nge = {
		...
		boolCircleCollision : function(circle1, circle2) {
		...
		boolRectangleCollision : function(rectangle1, rectangle2) {
		...
		boolCircleRectCollision : function(circle, rectangle) {
	...
	// ATTACH CLASS TO WINDOW OBJECT, SO IT IS ACCESSIBLE
	window.nge = nge;
